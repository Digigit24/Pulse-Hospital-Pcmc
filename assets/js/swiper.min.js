...
var Swiper = (function() {
    ...
    function p() {
        ...
        for (let a = 1; a < arguments.length; a += 1) {
            ...
            if (
                null != i &&
                ((s = i), !("undefined" != typeof window && void 0 !== window.HTMLElement ?
    ...
    var G = {
        ...
        updateSlides: function() {
            ...
            for (let a = 0; a < p; a += 1) {
                ...
                if (
                    ((L = 0),
                        c[a] && (i = c[a]),
                        P && e.grid.updateSlide(a, i, c), !c[a] || "none" !== b(i, "display"))
                ) {
            ...
            if (
                ((e.virtualSize = Math.max(e.virtualSize, r) + w),
                    ...
                    P && e.grid.updateWrapperSize(L, m), !s.centeredSlides)
            ) {
                const t = [];
            ...
            if (o && s.loop) {
                ...
                for (
                    let a = 0; a < e.virtual.slidesBefore + e.virtual.slidesAfter; a += 1
                )
            ...
            if (
                (p !== d && e.emit("slidesLengthChange"),
                    ...
                    e.emit("slidesUpdated"), !(o || s.cssMode || ("slide" !== s.effect && "fade" !== s.effect)))
            ) {
        ...
        updateClickedSlide: function(e, t) {
            ...
            !i &&
                ...
                t &&
                t.length > 1 &&
                t.includes(e) && [...t.slice(t.indexOf(e) + 1, t.length)].forEach((e) => {
                    !i &&
                        e.matches &&
            ...
            if (
                ...
                Array.isArray(o.controller.control) ?
                    ...
                    o.controller.control.loopFix({
                        ...e,
                        slideTo: o.controller.control.params.slidesPerView === m.slidesPerView &&
                            s,
                    });
            }
            o.emit("loopFix");
    ...
    function F(e) {
        ...
        (s.allowClick = !1), !r.cssMode && p.cancelable && p.preventDefault(),
        ...
        if (!i.isMoved) {
            ...
            (i.allowMomentumBounce = !1), !r.grabCursor ||
        ...
        if (
            (r.touchReleaseOnEdges && (x = 0),
                ...
                E && (p.preventedByNestedSwiper = !0), !s.allowSlideNext &&
    ...
    function q(e) {
        ...
        for (
            let e = 0; e < c.length; e += e < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup
        ) {
        ...
        return function(s) {
            ...
            "object" == typeof i && null !== i ?
                (!0 === e[a] && (e[a] = {
                    ...
                    !e[a].prevEl &&
                    !e[a].nextEl &&
                    (e[a].auto = !0), ["pagination", "scrollbar"].indexOf(a) >= 0 &&
                    e[a] &&
                    e[a].enabled &&
                    !e[a].el &&
                    (e[a].auto = !0),
                ...
                setBreakpoint: function() {
                    ...
                    o && !d ?
                        ...
                        (i.classList.add(`${a.containerModifierClass}grid`),
                            ...
                            e.emitContainerClasses()),
                        c && !u ? e.unsetGrabCursor() : !c && u && e.setGrabCursor(), ["navigation", "pagination", "scrollbar"].forEach((t) => {
        ...
        init(e) {
            ...
            t.emit("beforeInit"),
                ...
                t.slideTo(
                    ...
                    0,
                    t.params.runCallbacksOnInit, !1, !0
                ) :
                t.slideTo(
                ...
                a("click", (e, s) => {
                    ...
                    if (
                        ...
                        a.length ?
                            ...
                            i(!0 === e ? "navigationShow" : "navigationHide"), [...a, ...r]
                            .filter((e) => !!e)
                            .forEach((e) =>
        ...
        function(e) {
            ...
            function L(e) {
                if (!S(e) ||
                    !(function(e) {
                        ...
                        return (!!e.target.matches(s) || [...t.hostEl.querySelectorAll(s)].filter((t) =>
                            t.contains(e.target)
                        ).length > 0);
                    })(e)
                )
            ...
            function O() {
                ...
                t.wrapperEl.addEventListener("pointerdown", T, s),
                    t.wrapperEl.addEventListener("pointermove", M, a), ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
            ...
            function D() {
                ...
                t.wrapperEl.removeEventListener("pointerdown", T, s),
                    t.wrapperEl.removeEventListener("pointermove", M, a), ["pointerup", "pointercancel", "pointerout"].forEach((e) => {
